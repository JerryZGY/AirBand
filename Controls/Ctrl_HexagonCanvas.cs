    ...
    public class Ctrl_HexagonCanvas : Canvas
    {
        ...
        */
        private struct Hexagon
        {
            ...
            public static double CO = (Width - cW) / 2;               //ColumnOrigin 欄中點
            ...
            public static double RO = (Height - cH) / 2;              //RowOrigin 列中點
        ...
        public Ctrl_HexagonCanvas()
        {
            Loaded += (s, e) =>
            {
                ...
                if (InternalChildren.Count > 0 && InternalChildren.Count < 7)
                    ...
                    {
                        SetLeft(InternalChildren[i], DesignerProperties.GetIsInDesignMode(this)? HexagonPoint[i].X : Hexagon.CO);
                        SetTop(InternalChildren[i], DesignerProperties.GetIsInDesignMode(this) ? HexagonPoint[i].Y : Hexagon.RO);
                    }
            };
        }
    }
