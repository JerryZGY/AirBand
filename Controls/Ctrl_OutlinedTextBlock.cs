...
namespace AirBand.Controls
{
    ...
    public class Ctrl_OutlinedTextBlock : FrameworkElement
    {
        public static readonly DependencyProperty FillProperty = DependencyProperty.Register(
            "Fill",
            typeof(Brush),
            typeof(Ctrl_OutlinedTextBlock),
        ...
        {
            var Ctrl_OutlinedTextBlock = (Ctrl_OutlinedTextBlock)dependencyObject;
            Ctrl_OutlinedTextBlock.formattedText = null;
            Ctrl_OutlinedTextBlock.textGeometry = null;
            Ctrl_OutlinedTextBlock.InvalidateMeasure();
            Ctrl_OutlinedTextBlock.InvalidateVisual();
        }

        private static void OnFormattedTextUpdated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            var Ctrl_OutlinedTextBlock = (Ctrl_OutlinedTextBlock)dependencyObject;
            Ctrl_OutlinedTextBlock.UpdateFormattedText();
            Ctrl_OutlinedTextBlock.textGeometry = null;
            Ctrl_OutlinedTextBlock.InvalidateMeasure();
            Ctrl_OutlinedTextBlock.InvalidateVisual();
        }
