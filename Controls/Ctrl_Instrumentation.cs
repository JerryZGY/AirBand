...
namespace AirBand.Controls
{
    ...
    /// </summary>
    public class Ctrl_Instrumentation : FrameworkElement
    {
        #region Fields
        ...
        /// </summary>
        static Ctrl_Instrumentation()
        {
            Type ownerType = typeof(Ctrl_Instrumentation);
            IsEnabledProperty.OverrideMetadata(ownerType, new UIPropertyMetadata(false, OnIsEnabledChanged));
        }

        /// <summary>
        /// Initalizes a new instance of <see cref="Ctrl_Instrumentation"/>
        /// </summary>
        public Ctrl_Instrumentation()
        {
            isListening = false;
            radius = 0;
            center = new Point();
        ...
        {
            Ctrl_Instrumentation target = element as Ctrl_Instrumentation;
            if (target == null)
            {
                return;
            }
        ...
        private void CreateProgressPath(int variation)
        {
            if (variation > 10)
            {
                ...
                rotationAngle = Math.Abs(rotationAngle + 1).Normalize();
            }
        ...
        private void CreateGeomerty()
        {
            ...
            // Border geometry     
            borderGeometry = center.Create(6, 2, radius - 4, radius - 12);
        ...
        private void OnForegroundChanged(Brush newValue)
        {
            ...
            foregourndPen = new Pen(foregroundBrush, 5);
        ...
        private void OnActiveForegroundChanged(Brush newValue)
        {
            ...
            activePen = new Pen(activeForegourndBrush, 5);
            activePen.Freeze();
        }
